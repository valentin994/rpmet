...
<div class="lg:grid lg:grid-cols-3 lg:grid-rows-4 pb-16">
    ...
    <div class="flex flex-col justify-between lg:flex-row text-xl md:text-xl text-gray-500 text-center pt-8 pb-16">
        <div bind:this={account} class="flex flex-col justify-center items-center w-full h-full pb-4">
            ...
            <p class="py-8 px-2">Otkupljujemo od fizičih I pravnih osoba. Otpad od fizičkih osoba otkupljujemo u gotovini ili na transakcijski račun.</p>
        </div>
        <div bind:this={metal} class="flex flex-col justify-center items-center w-full h-full pb-4">
            ...
            <p class="py-8 px-2">Metalni otpad otkupljujemo na našoj lokaciji te vršimo prijevoz otpada na našu lokaciju. Posjedujemo kamione za prijevoz sekundarnih sirovina, kontejnere za odlaganje metala.</p>
        </div>
